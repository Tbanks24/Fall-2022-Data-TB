...
**Answer**Reads the rds file in the data folder that has the information from Cardin's press release page. The dataset has the date, title, url and the text from each release. 
...
**Task** Run the following code to gather the text for the first 10 press releases. **You don't have to run this. You aleady have the data.
...
**Task** Run the following code. - Gets rid of common word http. It's annoying to have urls in your words. 
...
**Answer** Makes the words unique, distinguishes them h by capitalization (i.e Dog is different from dog.)
...
**Answer**This code converts all the text in words to a common text.
...
**Answer**Not the most interesting thing.It includes common words like "and" and "the" that we use everyday. Not surprising that they would be used common. 
...
**Answer** This code used Anti join gets rid of stop words. It then calculates percentages, displays top 10.I would say that this is more interesting. The words covid, public, health, and community provide a vivid image of what the releases are about. 
...
**Answer** The top one word that appears the most in 2021 is health at 1177 times. The 2022 word that appears the most is project at 834. 
...
**Task** Run the following code and describe the results.
**Answer** The two word phrase that appeared the most was covid 19, which appears 786 times.  
...
**Task** Run the following code and describe the results.
**Answer**After 2021, the most common two-word phrase was project location. 
...
**Answer**I guess the word issue has multiple meanings. Issue of a book or magazine I would consider positive. Using the word issue in terms of a problem isn't always bad. There are good problems to have. This type of analysis doesn't take into account the context of a word. 
