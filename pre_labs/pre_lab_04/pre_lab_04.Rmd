...
**Answer**Yes, the column structures have the same labels. However, there UNA and OTH have their order switched. 
...
**Answer** There should be 24 rows and there are 24 rows. 
...
**Task** Create a new dataframe with PPP and NAICS data joined together. Add a description of what this code does to your reference notebook. (Ignore this description)
...
**Answer**Skipping answer for this task.
...
**Answer**Howard County has the highest percentage Asian plus population. Prince George's has the percentage of democrats, the same as the last question. Prince George's has the highest percentage of Black people over 18 and Howard has the highest percentage of Asians above 18. 
...
**Answer** 
The code below changes it to a character data type. 
```{r}
