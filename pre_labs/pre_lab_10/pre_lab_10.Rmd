...
https://datawrapper.dwcdn.net/fMh3R/1/ - Link to my bar chart published.
...
We just see the state of Maryland colored in shades of blue and green.I believe the map is separated by counties. We're no longer distracted by the bigger world map.  
...
Instead of seeing the Fips Code when I hover over the map, I see the name of the county. The decimal number is now also shown as a percentage. 

^^Mine also doesn't allow me to type in exactly "pctmoore." I keep getting an error message. 
...
https://datawrapper.dwcdn.net/QOPvd/1/ 
