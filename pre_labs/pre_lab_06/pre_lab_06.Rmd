...
"Jurisdiction Wide" is not a precinct and should not be included. This is why there are NA values in the row. "Bend" is separated from SUNRISE BEACH 2 & 3 AND WILSON and receives it's own row even though it's all part of one name. 
```{r}
...
**Answer**
Jurisdiction Wide should not be included because it's not a precinct. There's still a separate Bend row even though there's a row called "SUNRISE BEACH 2 & 3 AND WILSON BEND." 
...
**Answer** There are 21 rows compared to the 23 rows in Task 6. 
