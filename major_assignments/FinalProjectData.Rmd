...
Answer: The most recent criminal law procedure lobbyists registrants that were not previously registered before were Carrington, J. Darrell, Elliott, Robyn S, Hessler, Therese Marie, Lombardi, Joyce, McDonough, Caitlin E, Zeimer, Matan.

What I did: I went to the Count Sept22 to Nov data set since it already counted the distinct number of registrants from Sep. 2022 to Nov 22. I took the 19 names from that list, filtered them from the initial criminal law procdeure data set, and created a new dataframe. Afterwards, I looked through the new CrimeRecentReg data set to see if there were any registrants that did not repeat. 
