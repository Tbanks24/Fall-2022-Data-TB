...
**Answer**
Were creating a new dataset named maryland_top_counties
Arranging it in descending order of Total difference between the two years
Selecting to only see the county and total difference columns
Limiting the results to the top 10 rows.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** I see a bar chart with errors on the x axis that need to be cleaned up. 
...
**Answer**The bars are now rising in order of total difference. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
It switched the axis that the names were on. The names are now on the y axis and the total difference is on the x axis.The names are not running together anymore.
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**The gray background behind the graph has been removed.
...
**Answer**There is now a blue background behind the chart as well as white horizontal lines. 
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
The name of the chart on the left hand side has changed to net change. 
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**It shows the total number of contributions for a given day. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**I get a line graph with the months on the x axis and total contributions on the y axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**The date section now has Month and day in the x axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**It makes the dates on the x axis easier to read by slanting them 45 degrees. 
```{r}
md_winred_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_contributions)) + 
