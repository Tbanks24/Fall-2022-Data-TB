...
**Answer** 
For the ones named after the attorney general candidates have there parties right next to their names, making it look cluttered.The number of votes in those two columns also have commas that need to be removed.
...
**Answer** 
From left to right, it is refering to the positions of the columns in the chart. I.E peroutka is the second column from the left. 
```{r}
...
**Answer** 
The output shows that there are 57 li tags, however we can only see 20 of them. 
...
**Answer** In addition to getting committee names, we also get several values with n next to them. We don't want the n line next to it. 
...
**Answer** All the committee names are put under a column named value. The committees with n next to them are still there. 
